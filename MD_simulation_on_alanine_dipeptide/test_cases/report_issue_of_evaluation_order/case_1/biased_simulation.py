...
############################ PARAMETERS BEGIN ###############################################################
force_constant = sys.argv[1] # read force constant from command line argument
...
pdb_reporter_file = 'biased_output_%s.pdb' %(force_constant)
state_data_reporter_file = 'biased_report_%s.txt' %(force_constant)

xi_1_0 = "-1"  # they  are the coordinates of center of the potential well
xi_2_0 = "-1"
...
energy_expression = '''
%s * (raw_layer_1_unit_2 - %s)^2 + %s * (raw_layer_1_unit_3 - %s)^2;
