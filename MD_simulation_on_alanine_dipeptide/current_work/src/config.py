...
CONFIG_48 = 'Cartesian'           # input and output data type
temp_CONFIG_75_1 = np.ones(360); temp_CONFIG_75_1[3:24] = 4.0; temp_CONFIG_75_1[180 + 3: 180 + 24] = 4.0; temp_CONFIG_75_1 /= 4.0
CONFIG_75 = get_mol_param([None, temp_CONFIG_75_1, None, None])      # weights for the expected output (equivalent to modifying error functions)
...
CONFIG_74 = True                  # whether we start each biased simulation with nearest configuration or a fixed configuration
