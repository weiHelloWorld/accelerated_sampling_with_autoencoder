...
CONFIG_59 = 1000               # number of representative points
...
CONFIG_61 = ['_aligned%s_coordinates.npy' % item
...
CONFIG_14 = 50  # max number of jobs submitted each time
...
CONFIG_10 = 15               # num of bins for get_boundary_points()
...
CONFIG_9 = get_mol_param([5000, 2000, 3000, 3000])                     # force constant for biased simulations
