import copy, pickle, re, os, time, subprocess, datetime
...
class iteration(object):
    def __init__(self, index, 
                 ...
                 num_of_simulation_steps = 1000
                 ):  
        self._index = index
        self._network = network
        self._num_of_simulation_steps = num_of_simulation_steps
        
    def train_network_and_save(self, training_interval=None):
...
class single_biased_simulation_data(object):
    ...
    def get_distance_between_potential_center_and_data_cloud_center(self):
        ...
        distance = [PCs_average[0] - self._potential_center[0], PCs_average[1] - self._potential_center[1]]
        return distance
