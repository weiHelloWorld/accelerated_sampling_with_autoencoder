...
energy_expression_file = '../resources/biased_expression_4th_iteration.txt'

force_field_file = 'amber99sb.xml'
water_field_file = 'amber99_obc.xml'

pdb_reporter_file = '../target/biased_output_fc_%s_x1_%s_x2_%s.pdb' %(force_constant, xi_1_0, xi_2_0)
state_data_reporter_file = '../target/biased_report_fc_%s_x1_%s_x2_%s.txt' %(force_constant, xi_1_0, xi_2_0)
...
flag_random_seed = 0 # whether we need to set this random seed
